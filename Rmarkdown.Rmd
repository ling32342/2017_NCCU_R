...
- code會被```{r}及```包圍
- 快捷鍵（for windows、mac）：alt + control + i
- 將下列文字複製貼上並Knit：
...
- `include = FALSE` don't show code and output
...
<center>
<img src="img/RMDruncurrent.png" width="400px">
</center>


## Exercise - 2.1

<center> **請大家利用 iris 的資料依照不同的品種，**</center>
<center> **畫出 Sepal.Length 及 Petal.Length 的 scatter plot** </center>
...
<center>**請大家在 Rmarkdown 中產出將剛剛的 scatter plot**</center>
...
- `##` 代表一張投影片
- `#` 主題黑幕
- 要注意因為每張頭影片長度限制，所以須控制內容

## Flexdashboard - 1

- 安裝套件 `install.packages("flexdashboard")`
- 使用前 `install(flexdashboard)`
...
- [2017 Asia Open Data Hackthon Dashboard](https://pongponglin.github.io/2017Taiwan-power-data/%E8%B7%A8%E5%9C%8B%E9%BB%91%E5%AE%A2%E6%9D%BE.html)
