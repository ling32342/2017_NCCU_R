...
想要和我做朋有的人可以加我[臉書](https://www.facebook.com/profile.php?id=100000344369057)(4.請放你的臉書連結)
...
- [範例資料](https://lucy0222.github.io/2017_NCCU_R/data/weatherbig5.csv)
...
## Rmarkdown 呈現
[範例連結](https://lucy0222.github.io/2017_NCCU_R/RMDsample.html)
...
- 安裝 DT 套件，請執行 `install.packages("DT")`
- 記得 `library(DT)`
- 易於呈現、美化表格
...
- [參考範本](https://github.com/dspim/a1-basic-data-analysis-course/blob/master/RmdExQue.Rmd)
- [範例資料](https://lucy0222.github.io/2017_NCCU_R/data/weatherbig5.csv)
- [參考解答](https://github.com/lucy0222/2017_NCCU_R/blob/master/RMDsample.Rmd)
...
- 目錄的長寬可以變動
- 透過`fig_width`以及`fig_height: 7.5`參數調整
